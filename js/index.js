...
function verificarConexion() {
  $.ajax({
    url: "http://localhost/IDENTATRONICSV2/Adicionales/Agenda/server/verificar_database.php",
    type: "post",
    data: {},
    dataType: "json",
...
function crearDB() {
  ...
  $.ajax({
    url: "http://localhost/IDENTATRONICSV2/Adicionales/Agenda/server/crearDB.php",
    type: "post",
    data: {},
    dataType: "json",
    success: function (data) {
...
function crearTabla() {
  ...
  $.ajax({
    url: "http://localhost/IDENTATRONICSV2/Adicionales/Agenda/server/verificar_tablas.php",
    type: "post",
    data: {},
    dataType: "json",
    success: function (data) {
...
class Login {
  ...
  sendForm() {
    ...
    $.ajax({
      url: "http://localhost/IDENTATRONICSV2/Adicionales/Agenda/server/check_login.php",
      dataType: "json",
      cache: false,
      processData: false,
      contentType: false,
  ...
  generarUsuarios() {
    $.ajax({
      url: "http://localhost/IDENTATRONICSV2/Adicionales/Agenda/server/create_user.php",
      dataType: "json",
      cache: false,
      processData: false,
      contentType: false,
